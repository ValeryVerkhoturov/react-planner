...
function makeObjectMaxLOD() {
  ...
  // plane top
  let planeTop = new Three.Mesh(new Three.CylinderGeometry(7,7,0.5,30),brown);
...
export default {
  name: 'canteen rounded table with 4 chairs',
  prototype: 'items',

  info: {
    tag: ['furnishings', 'wood'],
    title: 'canteen rounded table with 4 chairs',
    description: 'canteen rounded table with 4 chairs',
    image: require('./canteen_rounded_table_with_4_chairs.png')
  },
